...
Your working directory is d:\sahma\Documents\GitHub\Systemoptimierungs_Windows\.agents\reviewer_m2_1.
...
Write a review report in your working directory at `d:\sahma\Documents\GitHub\Systemoptimierungs_Windows\.agents\reviewer_m2_1\review.md` and a handoff.md following the Handoff Protocol (Observation, Logic Chain, Caveats, Conclusion, Verification Method). Notify the parent orchestrator when done.
